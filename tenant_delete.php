...
<html>
  <head>
    <title>Nebenkostenabrechnung - Mieter löschen</title>
  ...
  <?php
    ...
    echo '>';
    echo '<div class="head">
            <h1>Mieter löschen</h1>
          </div>
          <div class="inhalt">
            <form action="tenant_delete.php?param_1=' . $_GET['param_1'] . '&param_2=' . $_GET['param_2'] . '" method="post">';
