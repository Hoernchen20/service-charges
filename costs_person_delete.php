...
<html>
  <head>
    <title>Nebenkostenabrechnung - Kosten pro Person löschen</title>
  ...
  <?php
    ...
    echo '>';
    echo '<div class="head">
            <h1>Kosten pro Person löschen</h1>
          </div>
          <div class="inhalt">
            <form action="costs_person_delete.php?param=' . $_GET['param'] .'" method="post">';
